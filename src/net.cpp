...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Senden " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"sendentools.com", "dnsseed.sendentools.com"},
    {"sendenpool.org", "dnsseed.sendenpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"sendentools.com", "testnet-seed.sendentools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Senden is probably already running."), addrBind.ToString().c_str());
        else
